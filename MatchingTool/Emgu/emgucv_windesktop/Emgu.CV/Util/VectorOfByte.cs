...
namespace Emgu.CV.Util
{
   ...
   public partial class VectorOfByte : Emgu.CV.Util.UnmanagedVector, ISerializable
#if true
      , IInputOutputArray
#endif
   {
      ...
      public override long Length
      {
         get
         {
            return VectorOfByteGetMemorySize(_ptr);
         }
      }
      ...
      {
         return new InputArray( cveInputArrayFromVectorOfByte(_ptr), this );
      }
      ...
      {
         return new OutputArray( cveOutputArrayFromVectorOfByte(_ptr), this );
      }
      ...
      {
         return new InputOutputArray( cveInputOutputArrayFromVectorOfByte(_ptr), this );
      }
#endif
	  ...
	  [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern long VectorOfByteGetMemorySize(IntPtr v);
...
#if true      
      [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern IntPtr cveInputArrayFromVectorOfByte(IntPtr vec);

      [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern IntPtr cveOutputArrayFromVectorOfByte(IntPtr vec);

      [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern IntPtr cveInputOutputArrayFromVectorOfByte(IntPtr vec);
#endif
   }
}
