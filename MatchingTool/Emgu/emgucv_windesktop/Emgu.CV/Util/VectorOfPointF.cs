...
namespace Emgu.CV.Util
{
   ...
   public partial class VectorOfPointF : Emgu.CV.Util.UnmanagedVector, ISerializable
#if true
      , IInputOutputArray
#endif
   {
      ...
      public override long Length
      {
         get
         {
            return VectorOfPointFGetMemorySize(_ptr);
         }
      }
      ...
      {
         return new InputArray( cveInputArrayFromVectorOfPointF(_ptr), this );
      }
      ...
      {
         return new OutputArray( cveOutputArrayFromVectorOfPointF(_ptr), this );
      }
      ...
      {
         return new InputOutputArray( cveInputOutputArrayFromVectorOfPointF(_ptr), this );
      }
#endif
	  ...
	  [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern long VectorOfPointFGetMemorySize(IntPtr v);
...
#if true      
      [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern IntPtr cveInputArrayFromVectorOfPointF(IntPtr vec);

      [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern IntPtr cveOutputArrayFromVectorOfPointF(IntPtr vec);

      [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern IntPtr cveInputOutputArrayFromVectorOfPointF(IntPtr vec);
#endif
   }
}
