...
namespace Emgu.CV.Util
{
   ...
   public partial class VectorOfInt : Emgu.CV.Util.UnmanagedVector, ISerializable
#if true
      , IInputOutputArray
#endif
   {
      ...
      public override long Length
      {
         get
         {
            return VectorOfIntGetMemorySize(_ptr);
         }
      }
      ...
      {
         return new InputArray( cveInputArrayFromVectorOfInt(_ptr), this );
      }
      ...
      {
         return new OutputArray( cveOutputArrayFromVectorOfInt(_ptr), this );
      }
      ...
      {
         return new InputOutputArray( cveInputOutputArrayFromVectorOfInt(_ptr), this );
      }
#endif
	  ...
	  [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern long VectorOfIntGetMemorySize(IntPtr v);
...
#if true      
      [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern IntPtr cveInputArrayFromVectorOfInt(IntPtr vec);

      [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern IntPtr cveOutputArrayFromVectorOfInt(IntPtr vec);

      [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern IntPtr cveInputOutputArrayFromVectorOfInt(IntPtr vec);
#endif
   }
}
