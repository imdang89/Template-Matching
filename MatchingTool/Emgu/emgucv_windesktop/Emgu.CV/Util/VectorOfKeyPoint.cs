...
namespace Emgu.CV.Util
{
   ...
   public partial class VectorOfKeyPoint : Emgu.CV.Util.UnmanagedVector, ISerializable
#if true
      , IInputOutputArray
#endif
   {
      ...
      public override long Length
      {
         get
         {
            return VectorOfKeyPointGetMemorySize(_ptr);
         }
      }
      ...
      {
         return new InputArray( cveInputArrayFromVectorOfKeyPoint(_ptr), this );
      }
      ...
      {
         return new OutputArray( cveOutputArrayFromVectorOfKeyPoint(_ptr), this );
      }
      ...
      {
         return new InputOutputArray( cveInputOutputArrayFromVectorOfKeyPoint(_ptr), this );
      }
#endif
	  ...
	  [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern long VectorOfKeyPointGetMemorySize(IntPtr v);
...
#if true      
      [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern IntPtr cveInputArrayFromVectorOfKeyPoint(IntPtr vec);

      [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern IntPtr cveOutputArrayFromVectorOfKeyPoint(IntPtr vec);

      [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern IntPtr cveInputOutputArrayFromVectorOfKeyPoint(IntPtr vec);
#endif
   }
}
