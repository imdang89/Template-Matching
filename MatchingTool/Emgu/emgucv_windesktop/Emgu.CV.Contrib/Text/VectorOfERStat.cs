...
namespace Emgu.CV.Text
{
   ...
   public partial class VectorOfERStat : Emgu.CV.Util.UnmanagedVector, ISerializable
#if true
      , IInputOutputArray
#endif
   {
      ...
      public override long Length
      {
         get
         {
            return VectorOfERStatGetMemorySize(_ptr);
         }
      }
      ...
      {
         return new InputArray( cveInputArrayFromVectorOfERStat(_ptr), this );
      }
      ...
      {
         return new OutputArray( cveOutputArrayFromVectorOfERStat(_ptr), this );
      }
      ...
      {
         return new InputOutputArray( cveInputOutputArrayFromVectorOfERStat(_ptr), this );
      }
#endif
	  ...
	  [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern long VectorOfERStatGetMemorySize(IntPtr v);
...
#if true      
      [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern IntPtr cveInputArrayFromVectorOfERStat(IntPtr vec);

      [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern IntPtr cveOutputArrayFromVectorOfERStat(IntPtr vec);

      [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern IntPtr cveInputOutputArrayFromVectorOfERStat(IntPtr vec);
#endif
   }
}
